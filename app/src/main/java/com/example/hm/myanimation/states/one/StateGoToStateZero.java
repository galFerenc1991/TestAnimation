 ...
 */
public class StateGoToStateZero implements State {
    ...
    public StateGoToStateZero(CustomBackground _customBackground){
...
//        animatorsGroup1.add(animatorForTwoCircle13);
        ...
        radiusAnimator1.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                customBackground.setState(customBackground.zero);
